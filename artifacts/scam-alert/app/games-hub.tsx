...
const GAMES: GameMeta[] = [
  ...
  },
  {
    ...
    description: "Guide your glowing neon snake around the grid, eat the pulsing dots and grow longer — but don't crash into yourself! Speed increases the bigger you get.",
    color: "#00CC88",
    scoreCollection: "snakeScores",
