...
const GAMES: GameMeta[] = [
  ...
  {
    id: "angelspirits",
    route: "/angel-vs-spirits",
    emoji: "⚔️",
    title: "Angel vs Spirits",
    subtitle: "Divine Fighting",
    description: "Take on the role of a mighty Archangel and battle against waves of evil spirits! Unleash heavenly strikes, charge your Divine Power and deliver holy judgement!",
    color: "#FFD700",
    scoreCollection: "angelScores",
    tags: ["Fighting", "Action", "Boss Rush"],
  },
  {
    id: "fraudflip",
    route: "/fraud-flip",
